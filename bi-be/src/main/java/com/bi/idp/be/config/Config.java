...
public class Config {
    ...
    private void configUserToUserDTOMapper(ModelMapper modelMapper) {
        ...
        modelMapper.typeMap(AdminAccount.class, UserDTO.class)
                .addMappings(mapper -> mapper.using(converter).map(AdminAccount::getRoles, UserDTO::setRoles));
    }
    ...
    private void configUserDTOToUserMapper(ModelMapper modelMapper) {
        ...
        modelMapper.typeMap(UserDTO.class, AdminAccount.class)
                .addMappings(mapper -> mapper.using(converter).map(UserDTO::getRoles, AdminAccount::setRoles));
    }
}
