...
public class AdminAccountSpecification implements Specification<AdminAccount> {
    ...
    public AdminAccountSpecification(SearchCriteria searchCriteria) {
        this.criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<AdminAccount> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
